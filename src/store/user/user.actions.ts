...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user: UserData, additionalData: AdditionalInformation}>
...
export const signUpSuccess = withMatcher((user: UserData, additionalData: AdditionalInformation): SignUpSuccess =>
